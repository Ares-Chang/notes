...
- 此电脑，右键点击属性，高级系统设置，环境变量
	...
	<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-03-30_18-52-50.png')">
	<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-03-30_18-53-53.png')">
	<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-03-30_18-54-44.png')">
	<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-03-31_10-24-30.png')">
	<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-03-31_10-36-03.png')">
...
<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-03-31_18-16-26.png')">
...
<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-03-31_18-00-35.png')">
...
<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-03-31_13-49-30.png')">
<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-03-31_13-50-56.png')">

安装完成会提示需要重启 IDE 才能生效，如果没有提示请自行重启。

<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-03-31_13-52-06.png')">
...
<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-04-01_13-30-41.png')">

选择一个模拟设备操作系统，如果本机没有，点击 Download 下载。

<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-04-01_13-32-22.png')">
...
<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-03-31_14-59-46.png')">
<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-03-31_15-14-50.png')">
<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-03-31_18-51-56.png')">

一般 win 都可以自动识别路径，如果地址没有自动选择，请自行选择。

<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-03-31_15-18-57.png')">

点击完成，等待项目加载完成。

然后点击 Tools ，选择 AVD Manager，启动模拟器，如果没有模拟器，请参照[新建模拟器](#新建模拟器)设置加载。

<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-04-01_16-45-40.png')">


点击运行或 debug 项目，等待底栏加载进度。

<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-04-01_14-30-28.png')">

加载完成自动打开模拟器，注意需要手动开机，点击开机按钮。

<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-04-01_16-49-41.png')">
...
<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-04-01_18-25-17.png')">
...
<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-04-02_10-35-23.png')">
...
<img class="zoom" :src="$withBase('/flutter/Snipaste_2021-04-02_17-10-59.png')">
